...
public class PopWindowMenu extends PopupWindow {
    ...
    public PopWindowMenu(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        ...
        ColorDrawable dw = new ColorDrawable(0x92989494);
        ...
        mMenuView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                int height = mMenuView.findViewById(R.id.id_recycler_Allmusic).getTop();
